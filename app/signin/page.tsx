...
export default function SignIn() {
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-lg mx-auto h-screen justify-center items-center px-4">
      ...
      <div className="w-full bg-slate-100 dark:bg-slate-800 p-8 rounded-2xl shadow-xl border border-slate-300 dark:border-slate-600 flex flex-col gap-4">
        <button
          onClick={() => void signIn("google")}
          className="flex items-center justify-center gap-3 bg-white hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-950 text-slate-900 dark:text-white font-semibold rounded-lg py-3 border-2 border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
        >
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-medium">
              OR
            </span>
          </div>
        </div>
